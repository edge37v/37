...
const file = "node_modules\\carbon-components-svelte\\src\\Link\\Link.svelte";
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			toggle_class(a, "bx--link--disabled", /*disabled*/ ctx[3]);
			toggle_class(a, "bx--link--inline", /*inline*/ ctx[2]);
			toggle_class(a, "bx--link--visited", /*visited*/ ctx[4]);
			add_location(a, file, 49, 2, 1012);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen_dev(a, "mouseover", /*mouseover_handler_1*/ ctx[13], false, false, false),
					listen_dev(a, "mouseenter", /*mouseenter_handler_1*/ ctx[14], false, false, false),
					listen_dev(a, "mouseleave", /*mouseleave_handler_1*/ ctx[15], false, false, false)
				];
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			toggle_class(p, "bx--link--disabled", /*disabled*/ ctx[3]);
			toggle_class(p, "bx--link--inline", /*inline*/ ctx[2]);
			toggle_class(p, "bx--link--visited", /*visited*/ ctx[4]);
			add_location(p, file, 33, 2, 670);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen_dev(p, "mouseenter", /*mouseenter_handler*/ ctx[10], false, false, false),
					listen_dev(p, "mouseleave", /*mouseleave_handler*/ ctx[11], false, false, false)
				];
		...
		p: function update(ctx, dirty) {
			...
			set_attributes(p, p_data = get_spread_update(p_levels, [dirty & /*$$restProps*/ 32 && /*$$restProps*/ ctx[5]]));
			toggle_class(p, "bx--link", true);
			toggle_class(p, "bx--link--disabled", /*disabled*/ ctx[3]);
			toggle_class(p, "bx--link--inline", /*inline*/ ctx[2]);
			toggle_class(p, "bx--link--visited", /*visited*/ ctx[4]);
...
function instance($$self, $$props, $$invalidate) {
	const omit_props_names = ["href","inline","disabled","visited","ref"];
	...
	$$self.$$set = $$new_props => {
		...
		if ("visited" in $$new_props) $$invalidate(4, visited = $$new_props.visited);
		if ("ref" in $$new_props) $$invalidate(0, ref = $$new_props.ref);
		if ("$$scope" in $$new_props) $$invalidate(6, $$scope = $$new_props.$$scope);
	};

	$$self.$capture_state = () => ({ href, inline, disabled, visited, ref });

	$$self.$inject_state = $$new_props => {
		if ("href" in $$props) $$invalidate(1, href = $$new_props.href);
		if ("inline" in $$props) $$invalidate(2, inline = $$new_props.inline);
		if ("disabled" in $$props) $$invalidate(3, disabled = $$new_props.disabled);
		if ("visited" in $$props) $$invalidate(4, visited = $$new_props.visited);
...
const file$1 = "node_modules\\carbon-components-svelte\\src\\Grid\\Grid.svelte";
...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$1, 64, 2, 1481);
		},
		m: function mount(target, anchor) {
...
const file$2 = "node_modules\\carbon-components-svelte\\src\\Grid\\Row.svelte";
...
function create_else_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			set_attributes(div, div_data);
			add_location(div, file$2, 57, 2, 1303);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
const file$3 = "node_modules\\carbon-components-svelte\\src\\Grid\\Column.svelte";
...
function create_else_block$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			set_attributes(div, div_data);
			add_location(div, file$3, 120, 2, 2914);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
const file$4 = "node_modules\\carbon-components-svelte\\src\\UIShell\\Content.svelte";
...
function create_fragment$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(main, file$4, 8, 0, 147);
		},
		m: function mount(target, anchor) {
...
function instance$5($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ getContext, ctx });
...
function instance$6($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$props => {
		...
		if ("persistKey" in $$props) $$invalidate(2, persistKey = $$props.persistKey);
		if ("theme" in $$props) $$invalidate(0, theme = $$props.theme);
		if ("_document" in $$props) _document = $$props._document;
	};
...
// (12:2) <Content style="background: none; padding: 1rem">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(12:2) <Content style=\\\"background: none; padding: 1rem\\\">",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(10:0) <Theme persist theme=\\\"g10\\\">",
		ctx
	});
...
function instance$7($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ Content, Grid, Header, Theme });
	return [$$slots, $$scope];
}
...
function create_if_block$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(pre, file$5, 18, 8, 362);
			add_location(div, file$5, 17, 6, 348);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, pre);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(17:4) {#if dev && error.stack}",
		ctx
	});
...
function create_default_slot_1$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file$5, 11, 4, 205);
			add_location(div, file$5, 12, 4, 227);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			...
			if ((!current || dirty & /*error*/ 2) && t2_value !== (t2_value = /*error*/ ctx[1].message + "")) set_data_dev(t2, t2_value);
			const link_changes = {};
...
function instance$8($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ status, error, Row, Column, Link, dev });
